...
const styles = StyleSheet.create({
  ...
  page: {
    padding: 56,
    // Do NOT hardcode `fontFamily: "Helvetica"` — Helvetica has no Arabic
    // glyphs, so Arabic content renders as empty boxes. We rely on
    // react-pdf's default font stack unless a caller registers a custom
    // Arabic-capable font via Font.register().
    color: palette.body,
    fontSize: 11,
    lineHeight: 1.55,
  },
