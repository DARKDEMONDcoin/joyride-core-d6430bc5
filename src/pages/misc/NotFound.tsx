...
const NAV_LINKS = [
  ...
  { label: "الصور", href: "/images" },
  { label: "الفيديو", href: "/videos" },
  { label: "البناء", href: "/build" },
...
const FOOTER_COLUMNS: { title: string; links: { label: string; href: string }[] }[] = [
  {
    title: "المنتج",
    links: [
      { label: "محادثة AI", href: "/chat" },
      { label: "توليد الصور", href: "/images" },
      { label: "توليد الفيديو", href: "/videos" },
      { label: "Megsy PR", href: "/build" },
      { label: "الشركات", href: "/enterprise" },
    ],
  },
  {
    title: "الشركة",
